...
- Les programmes Bug Bounty autorisés (HackerOne, Bugcrowd, Intigriti, YesWeHack...)
- Les tests de pénétration sur des systèmes dont vous êtes propriétaire ou pour lesquels vous avez une autorisation écrite
...
- ⚡ VULN ONLY    → Scan de vulnérabilités uniquement
- 🔍 OSINT ONLY  → Reconnaissance passive uniquement
